    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border border-[#e5dbdb] dark:border-gray-700 dark:bg-gray-800 transition-colors duration-300">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[#171212] dark:text-white">Total Staff</CardTitle>
        ...
        <Card className="border border-[#e5dbdb] dark:border-gray-700 dark:bg-gray-800 transition-colors duration-300">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[#171212] dark:text-white">New This Month</CardTitle>
        ...
        <Card className="border border-[#e5dbdb] dark:border-gray-700 dark:bg-gray-800 transition-colors duration-300">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[#171212] dark:text-white">Activity</CardTitle>
      ...
      <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
        <p className="text-sm text-green-800">
          ✅ Login successful! Using mock data.
        </p>
